...
Statisk app som visar flera lördagar: Kent, Lotta och Benitas Dagens Dubbel, system, kostnad och resultat. Ingen build. Samma filer fungerar på GitHub Pages och när du öppnar mappen i Cursor eller Claude Code.
...
4. Lägg `kent.md`, `lotta.md`, `benita.md` i veckomappen. Kupongbilder valfritt.
